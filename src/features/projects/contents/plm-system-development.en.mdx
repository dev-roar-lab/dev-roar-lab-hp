...
summary: 'Responsible for PLM package customization, web application development, and AWS infrastructure construction and operations'
tags: ['C#', 'ASP.NET Core', 'PostgreSQL', 'AWS', 'Terraform', 'CI/CD']
---

## Project Overview

Worked on contract development of PLM (Product Lifecycle Management) packages for the manufacturing industry. Responsible for Aras Innovator customization, web application development using ASP.NET Core, AWS infrastructure construction and operations, CI/CD pipeline implementation, and customer in-house development support.
...
- Implementation of Excel-like UI that couldn't be achieved with Aras
...
- Built automatic deployment for web applications using **AWS CodePipeline**
- Automated unit test execution on PR trigger using **CodeBuild**
...
- Automated unit test execution on PR trigger
